...
Created a python main file first. Thought about all inputs needed from the user. Inputs to be read from the user:
- number of ideas (n)
- n ideas
- number of criteria (m)
- the m criterias
- weights of criterias with their type (whether maximizing or minimizing)
- score of each criterias for the each idea
